...
// Displays the list of closed Returnable DCs with filtering and sorting
function DCListClosed() {
  ...
  useEffect(() => {
    // Fetches closed DCs and customer names on mount
    async function fetchData() {
      try {
        ...
        setClosedTable(dcResponse.data);
    ...
    <div>
      ...
      <h5 className="mt-1">
        <label className="form-label">
          PN List : Returnable DC Status Closed
        </label>
      </h5>
